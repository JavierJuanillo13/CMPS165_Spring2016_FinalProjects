...
var menu = d3.select("#menu")
        .attr("style", "width:" + (m_width + m_margin.left + m_margin.right) + "px;height:" + (m_height + m_margin.top + m_margin.bottom) + "px;")
    .append("svg")
...
d3.json("src/json/foods.json", function(error, m_data) {
    ...
    var m_tip = d3.tip()
        ...
        .html(function(d) {
            ...
            data += "<div class='clearfix'><strong>Serving</strong><em>"       + d.serving       + " g</em></div>";
            data += "<div class='clearfix'><strong>Calories</strong><em>"      + d.calories      + "</em></div>";
            data += "<div class='clearfix'><strong>Cholesterol</strong><em>"   + d.cholesterol   + " mg</em></div>";
            data += "<div class='clearfix'><strong>Sodium</strong><em>"        + d.sodium        + " mg</em></div>";
            data += "<div class='clearfix'><strong>Fat</strong><em>"           + d.fat           + " g</em></div>";
            data += "<div class='clearfix'><strong>Carbohydrates</strong><em>" + d.carbohydrates + " g</em></div>";
            data += "<div class='clearfix'><strong>Sugar</strong><em>"         + d.sugar         + " g</em></div>";
            data += "<div class='clearfix'><strong>Protein</strong><em>"       + d.protein       + " g</em></div>";
...
function update_plate_totals() {
    ...
    for (var i = 0; i < p_data.length; i++) {
        ...
        fat += p_data[i].fat;
        carbohydrates += p_data[i].carbohydrates;
        sugar += p_data[i].sugar;
        protein += p_data[i].protein;
    }
    ...
    d3.select("#your_plate_carbohydrates").text(format_number(carbohydrates)).classed("your_plate_warning", carbohydrates > bmi * 0.38 / 16);
    d3.select("#your_plate_sugar").text(format_number(sugar)).classed("your_plate_warning", sugar > bmi * 0.25 / 16);
    d3.select("#your_plate_protein").text(format_number(protein)).classed("your_plate_warning", protein !== 0 && protein < weight / 2.2 * 0.8 / 4);
}
...
function update_recommendation() {
    ...
    d3.select("#recommendation_carbohydrates").text(format_number(bmi * 0.38 / 16));
    d3.select("#recommendation_sugar").text(format_number(bmi * 0.25 / 16));
    d3.select("#recommendation_protein").text(format_number(weight / 2.2 * 0.8 / 4));
}
